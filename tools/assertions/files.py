...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
    """
    Проверяет, что ответ API при запросе файла с некорректным file_id
    соответствует ожидаемой валидационной ошибке.

    :param actual: Ответ API с ошибкой валидации.
    :raises AssertionError: Если ответ не совпадает с ожидаемой структурой.
    """
    expected = ValidationErrorResponseSchema(
        details=[
            ValidationErrorSchema(
